...
const NAV_ITEMS = [
  ...
  { href: '/comparativos',     label: 'Comparativos',       icon: FileSpreadsheet, roles: ['SUPER_ADMIN', ...OPS], allowEmails: COMPARATIVOS_ALLOWED_EMAILS },
  { href: '/cotizador',        label: 'Cotizador',          icon: Calculator,      roles: ['SUPER_ADMIN', ...OPS] },
